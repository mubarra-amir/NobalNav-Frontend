  ...
  const services = [
    {
      ...
      description: "Expert guidance for pursuing higher education in top universities worldwide.",
    },
    {
      icon: Globe,
      title: "Visa Assistance",
      description: "Complete visa support including documentation and application processing.",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "End-to-end assistance with application forms, essays, and documentation.",
    },
  ];
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      country: "UK",
      text: "Nobal Navigator made my dream of studying at Oxford a reality. Their guidance was invaluable!",
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop",
    },
    {
      name: "Raj Patel",
      country: "Canada",
      text: "The visa process seemed daunting, but the team handled everything smoothly. Highly recommended!",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop",
    },
    {
      name: "Emma Williams",
      country: "Australia",
      text: "Professional, responsive, and genuinely caring. They helped me secure admission to my top choice!",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/contact">
                  <Button size="lg" className="bg-white border-2 border-white text-blue-900 hover:bg-white hover:bg-blue-50 shadow-lg transition-all ">
                    Contact Us
                  </Button>
                </Link>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl text-blue-900 mb-6">
                Why Choose Nobal Navigator?
              </h2>
              <div className="space-y-4">
                <div className="flex gap-3">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl text-blue-900 mb-1">Expert Counselors</h3>
                    <p className="text-gray-600">Experienced team with in-depth knowledge of international education systems.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl text-blue-900 mb-1">End-to-End Support</h3>
                    <p className="text-gray-600">From university selection to visa approval and pre-departure guidance.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl text-blue-900 mb-1">High Success Rate</h3>
                    <p className="text-gray-600">98% visa approval rate and successful placements in top universities.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl text-blue-900 mb-1">Personalized Approach</h3>
                    <p className="text-gray-600">Tailored guidance based on your academic profile and career goals.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-900 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/contact">
              <Button size="lg" variant="outline" className="border-2 border-white bg-transparent text-white hover:bg-white hover:text-blue-900 transition-all shadow-lg">
