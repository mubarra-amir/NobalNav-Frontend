...
export default function AdminDashboard() {
  ...
  const [bookings] = useState<Booking[]>([
    {
      ...
      date: "2026-04-05",
      time: "10:00 AM",
      service: "Study Abroad Consultation - UK",
      status: "confirmed",
      country: "United Kingdom",
      educationLevel: "Undergraduate",
      message: "Interested in Computer Science programs",
      bookedAt: "2026-03-28T10:30:00",
    },
    {
      id: "BK002",
      name: "Priya Patel",
      ...
      date: "2026-04-06",
      time: "02:00 PM",
      service: "Study Abroad Consultation - USA",
      status: "pending",
      country: "United States",
      educationLevel: "Graduate/Master's",
      message: "Looking for MBA programs",
      bookedAt: "2026-03-28T14:15:00",
    },
    {
      id: "BK003",
      name: "Amit Kumar",
    ...
    },
    {
      ...
      date: "2026-03-30",
      time: "03:00 PM",
      service: "Study Abroad Consultation - Australia",
      status: "completed",
      country: "Australia",
      educationLevel: "Undergraduate",
      message: "Want to study Engineering",
      bookedAt: "2026-03-25T11:20:00",
    },
    {
      id: "BK005",
      name: "Arjun Mehta",
      ...
      date: "2026-04-08",
      time: "09:30 AM",
      service: "Study Abroad Consultation - Europe",
      status: "pending",
      country: "Germany",
      educationLevel: "PhD/Doctorate",
      message: "Research opportunities in Physics",
      bookedAt: "2026-03-29T16:45:00",
    },
    {
      id: "BK006",
      name: "Maya Singh",
      ...
      date: "2026-04-01",
      time: "04:30 PM",
      service: "University Selection Guidance",
      status: "completed",
      country: "United Kingdom",
      educationLevel: "Graduate/Master's",
      bookedAt: "2026-03-26T13:30:00",
    },
  ]);
  ...
  const exportToCSV = () => {
    ...
    const rows = filteredBookings.map((b) => [
      b.id, b.name, b.email, b.phone, b.date, b.time, b.service, b.status,
    ]);
                      ...
                      {filteredBookings.length === 0 ? (
                        ...
                        filteredBookings.map((booking) => (
                          <TableRow key={booking.id}>
                            ...
                            <TableCell>
                              <div className="text-sm max-w-xs">{booking.service}</div>
                            </TableCell>
                            <TableCell>
