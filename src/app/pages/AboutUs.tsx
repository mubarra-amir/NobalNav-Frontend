  ...
  const values = [
    {
      icon: Target,
      title: "Our Mission",
      description: "To empower students with world-class education opportunities by providing expert guidance and comprehensive support throughout their study abroad journey.",
    },
    {
      icon: Users,
      title: "Our Vision",
      description: "To be the most trusted study abroad consultancy, connecting ambitious students with their dream universities worldwide.",
    },
    {
      icon: Award,
      title: "Our Values",
      description: "Integrity, Excellence, Student-Centric Approach, Innovation, and Commitment to Success.",
    },
  ];
  ...
  const team = [
    {
      ...
      role: "Founder & CEO",
      description: "15+ years in international education consultancy",
      image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300&h=300&fit=crop",
    },
    {
      name: "Sarah Mitchell",
      role: "Head of Admissions",
      description: "Expert in UK & Europe university placements",
      image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=300&h=300&fit=crop",
    },
    {
      name: "Michael Chen",
      role: "Visa Specialist",
      description: "Specialist in USA, Canada & Australia visas",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop",
    },
    {
      name: "Priya Sharma",
      role: "Student Counselor",
      description: "Personalized guidance for 500+ students",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl text-blue-900 mb-6">
                Empowering Students Since 2015
              </h2>
              <p className="text-gray-600 mb-4 text-lg">
                Nobal Navigator Pvt Ltd is a premier study abroad consultancy dedicated to helping students achieve their international education goals. With over a decade of experience, we have successfully guided more than 1,000 students to prestigious universities across the globe.
              </p>
              <p className="text-gray-600 mb-4 text-lg">
                Our team of expert counselors provides comprehensive support throughout the entire journey - from selecting the right university and course to visa approval and pre-departure guidance. We specialize in admissions to top institutions in the UK, Ireland, Sweden, Finland, USA, Australia, Canada, Cyprus, and across Europe.
              </p>
              <p className="text-gray-600 text-lg">
                What sets us apart is our personalized approach, high success rate, and commitment to student satisfaction. We don't just help you get admitted - we ensure you're prepared for success in your chosen destination.
              </p>
            </div>
            <div>
              <ImageWithFallback
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 text-center">
              <div>
                ...
                <div className="text-blue-100">Best Consultancy 2023</div>
              </div>
              <div>
                <div className="text-4xl mb-2">⭐</div>
                <div className="text-blue-100">4.9/5 Student Rating</div>
              </div>
              <div>
                <div className="text-4xl mb-2">🎓</div>
                <div className="text-blue-100">Top University Partners</div>
              </div>
              <div>
                <div className="text-4xl mb-2">🌍</div>
                <div className="text-blue-100">Global Reach</div>
              </div>
            </div>
          </div>
        </div>
