...
export default function BookAppointment() {
  ...
  const services = [
    "Study Abroad Consultation - UK",
    "Study Abroad Consultation - USA",
    "Study Abroad Consultation - Canada",
    "Study Abroad Consultation - Australia",
    "Study Abroad Consultation - Europe",
    "Visa Assistance",
  ...
  const countries = [
    ...
    "Sweden", "Finland", "Germany", "France", "Cyprus", "Other"
  ];

  const educationLevels = [
    "High School", "Undergraduate", "Graduate/Master's", "PhD/Doctorate", "Other"
  ];
              ...
              {[
                ...
                <div key={stepItem.num} className="flex items-center flex-1">
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <span className="text-sm mt-2 text-gray-600 hidden sm:block">
                      {stepItem.label}
                    </span>
                  </div>
                  {stepItem.num < 4 && (
                  ...
                  {selectedDate && (
                    <div className="mt-6 p-4 bg-blue-50 rounded-lg text-center">
                      <p className="text-blue-900">
                        Selected Date: <span className="font-semibold">{format(selectedDate, "PPPP")}</span>
                      </p>
                    </div>
                  )}
              ...
              {step === 2 && (
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Selected Date: <span className="font-semibold">{selectedDate && format(selectedDate, "PPPP")}</span>
                  </p>
                    ...
                    {services.map((service) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className={selectedService === service ? "text-blue-900" : "text-gray-700"}>
                            {service}
                          </span>
                        </div>
                      </button>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="text-lg text-blue-900 mb-2">Duration</h3>
                  <p className="text-sm text-gray-600">60-90 minutes consultation</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <CheckCircle2 className="w-8 h-8 text-blue-600 mb-3" />
                  <h3 className="text-lg text-blue-900 mb-2">Free Service</h3>
                  <p className="text-sm text-gray-600">Initial consultation is completely free</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <CalendarIcon className="w-8 h-8 text-blue-600 mb-3" />
                  <h3 className="text-lg text-blue-900 mb-2">Flexible</h3>
                  <p className="text-sm text-gray-600">Easy rescheduling options available</p>
                </CardContent>
              </Card>
            </div>
          )}
